...
grep -q 'onedrive --sync --verbose --dry-run' "$ROOT/scripts/onedrive-bootstrap.sh"
grep -q 'configure_onedrive_links' "$ROOT/scripts/onedrive-bootstrap.sh"
grep -q 'systemctl --user enable --now onedrive.service' "$ROOT/scripts/onedrive-bootstrap.sh"
