...
declare -a ansible_args=(
  ...
  --extra-vars "manage_default_applications=$MANAGE_DEFAULT_APPLICATIONS"
  --extra-vars "default_browser=$DEFAULT_BROWSER"
  --extra-vars "default_mail_handler=$DEFAULT_MAIL_HANDLER"
  --extra-vars "default_file_manager=$DEFAULT_FILE_MANAGER"
  --extra-vars "default_terminal=$DEFAULT_TERMINAL"
  --extra-vars "default_text_editor=$DEFAULT_TEXT_EDITOR"
  --extra-vars "default_code_editor=$DEFAULT_CODE_EDITOR"
  --extra-vars "default_image_viewer=$DEFAULT_IMAGE_VIEWER"
  ...
  --extra-vars "onedrive_initial_sync_background=$ONEDRIVE_INITIAL_SYNC_BACKGROUND"
  --extra-vars "onedrive_notify_on_completion=$ONEDRIVE_NOTIFY_ON_COMPLETION"
  ...
  --extra-vars "edge_prepare_before_oauth=$EDGE_PREPARE_BEFORE_OAUTH"
